        ...
        View::composer('components.testimonials-carousel', function ($view) {
            $testimonials = [
                ...
                [
                    ...
                    'name'   => 'Biei Kohou',
                    'role'   => 'Fondatrice — Griffe d\'Amour',
                    'rating' => 5,
                    'avatar' => null,
                ],
                [
                ...
                [
                    ...
                    'name'   => 'Judikael Lacroix',
                    'role'   => 'Fondatrice — Staresia Paris',
                    'rating' => 5,
                    'avatar' => null,
                ],
                [
