...
<section class="w-full py-20 px-6 md:px-12 lg:px-20 bg-gray-950 text-gray-100 relative overflow-hidden">
    <!-- Fond dégradé -->
    <div class="absolute inset-0 -z-10 bg-gradient-to-br from-purple-900/30 via-gray-950 to-black"></div>
    <div class="absolute top-0 right-0 w-[30rem] h-[30rem] bg-purple-600/20 blur-3xl rounded-full"></div>
    <div class="absolute bottom-0 left-0 w-[20rem] h-[20rem] bg-pink-600/20 blur-3xl rounded-full"></div>
    ...
    <div class="text-center max-w-3xl mx-auto mb-16">
        ...
        <a href="#"
           class="mt-8 inline-block px-6 py-3 text-lg font-semibold rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white shadow-lg shadow-purple-500/30 hover:scale-105 transition-transform duration-300
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto">
        @foreach($steps as $i => $step)
            <div class="opacity-0 translate-y-10 relative bg-gray-900/80 rounded-3xl p-8 shadow-lg border border-gray-800 backdrop-blur-lg
                        transition-all duration-700 hover:scale-105 hover:-rotate-1 hover:shadow-purple-500/40 hover:border-purple-500 group"
                 x-data
                ...
                <!-- Numéro -->
                <div class="absolute -top-5 left-1/2 transform -translate-x-1/2 w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold text-lg shadow-lg shadow-purple-600/40">
                    {{ $step['number'] }}
                </div>
